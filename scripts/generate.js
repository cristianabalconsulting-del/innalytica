...
const { compute } = lib;                 // <-- RESTAURADO: usa compute() del proxy Power BI
const tm  = require('./events-tm.js');   // <-- RESTAURADO: eventos (Ticketmaster)
const hol = require('./holidays.js');    // <-- RESTAURADO: festividades (Nager + Calendarific)
