...
function buildQueries(year, aloj) {
  ...
  const F26 = `'Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Status]="CONFIRMED"&&YEAR('Informe Reservas Total'[Fecha Estancia])=${year}&&'Informe Reservas Total'[Conexion]="OK"`;
  const F25 = F26.replace(`=${year}`, `=${prevYear}`);
...
ytdToday: `EVALUATE ROW("Rev",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F26}&&'Informe Reservas Total'[Fecha Estancia]<=${todayDAX})),"RN",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F26}&&'Informe Reservas Total'[Fecha Estancia]<=${todayDAX})),"BK",CALCULATE(DISTINCTCOUNT('Informe Reservas Total'[Refer]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F26}&&'Informe Reservas Total'[Fecha Estancia]<=${todayDAX})),"Ni",CALCULATE(SUM('Informe Reservas Total'[Nights]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F26}&&'Informe Reservas Total'[Fecha Estancia]<=${todayDAX})),"Rev25",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F25}&&'Informe Reservas Total'[Fecha Estancia]<=${prevYearSameDay})),"RN25",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F25}&&'Informe Reservas Total'[Fecha Estancia]<=${prevYearSameDay})),"BK25",CALCULATE(DISTINCTCOUNT('Informe Reservas Total'[Refer]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F25}&&'Informe Reservas Total'[Fecha Estancia]<=${prevYearSameDay})))`,
    ...
    bwProp26: `EVALUATE SUMMARIZECOLUMNS(Habitaciones[Property],FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total',${F26}),"n0",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=1)),"r0",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=1)),"n1",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=2&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=7)),"r1",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=2&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=7)),"n2",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=8&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=14)),"r2",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=8&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=14)),"n3",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=15&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=30)),"r3",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=15&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=30)),"n4",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=31&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=60)),"r4",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=31&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=60)),"n5",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=61&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=90)),"r5",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=61&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=90)),"n6",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>90)),"r6",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>90)))`,
    ...
    bookerCty: `EVALUATE CALCULATETABLE(SUMMARIZECOLUMNS('Informe Reservas Total'[Country],"bk",DISTINCTCOUNT('Informe Reservas Total'[Refer]),"rn",COUNTROWS('Informe Reservas Total'),"rev",SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),"bwsum",SUMX('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY))),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F26}))`,

    salesDay: `EVALUATE CALCULATETABLE(SUMMARIZECOLUMNS('Fechas estancia'[Date],Habitaciones[Property],Habitaciones[Tipo Habitación],"RN",COUNTROWS('Informe Reservas Total'),"BK",DISTINCTCOUNT('Informe Reservas Total'[Refer]),"Ni",SUM('Informe Reservas Total'[Nights]),"Pax",SUM('Informe Reservas Total'[GUESTS]),"RevR",SUM('Informe Reservas Total'[ADR ING]),"Clean",SUM('Informe Reservas Total'[Cleaning Diario]),"Extra",SUM('Informe Reservas Total'[Extras Diario]),"ComR",SUM('Informe Reservas Total'[room_commission_price]),"ComC",SUM('Informe Reservas Total'[cf_commission_price]),"BWsum",SUMX('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY))),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total',${F26}))`,


    salesDim: `EVALUATE CALCULATETABLE(SUMMARIZECOLUMNS('Fechas estancia'[Year],'Fechas estancia'[Month],Habitaciones[Property],Habitaciones[Tipo Habitación],Habitaciones[Location],'Informe Reservas Total'[Source Filtro],'Informe Reservas Total'[Rate plan],'Informe Reservas Total'[Country],"RN",COUNTROWS('Informe Reservas Total'),"BK",DISTINCTCOUNT('Informe Reservas Total'[Refer]),"Ni",SUM('Informe Reservas Total'[Nights]),"Pax",SUM('Informe Reservas Total'[GUESTS]),"RevR",SUM('Informe Reservas Total'[ADR ING]),"Clean",SUM('Informe Reservas Total'[Cleaning Diario]),"Extra",SUM('Informe Reservas Total'[Extras Diario]),"ComR",SUM('Informe Reservas Total'[room_commission_price]),"ComC",SUM('Informe Reservas Total'[cf_commission_price]),"BWsum",SUMX('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY))),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total',${F26}))`,


    salesDimLY: `EVALUATE CALCULATETABLE(SUMMARIZECOLUMNS('Fechas estancia'[Year],'Fechas estancia'[Month],Habitaciones[Property],Habitaciones[Tipo Habitación],Habitaciones[Location],'Informe Reservas Total'[Source Filtro],'Informe Reservas Total'[Rate plan],'Informe Reservas Total'[Country],"RN",COUNTROWS('Informe Reservas Total'),"BK",DISTINCTCOUNT('Informe Reservas Total'[Refer]),"Ni",SUM('Informe Reservas Total'[Nights]),"Pax",SUM('Informe Reservas Total'[GUESTS]),"RevR",SUM('Informe Reservas Total'[ADR ING]),"Clean",SUM('Informe Reservas Total'[Cleaning Diario]),"Extra",SUM('Informe Reservas Total'[Extras Diario]),"ComR",SUM('Informe Reservas Total'[room_commission_price]),"ComC",SUM('Informe Reservas Total'[cf_commission_price]),"BWsum",SUMX('Informe Reservas Total',DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY))),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total',${F25}))`,


    salesCanc: `EVALUATE CALCULATETABLE(SUMMARIZECOLUMNS('Fechas estancia'[Year],'Fechas estancia'[Month],Habitaciones[Property],Habitaciones[Tipo Habitación],Habitaciones[Location],'Informe Reservas Total'[Source Filtro],'Informe Reservas Total'[Rate plan],'Informe Reservas Total'[Country],"cRN",COUNTROWS('Informe Reservas Total'),"cBK",DISTINCTCOUNT('Informe Reservas Total'[Refer]),"cRev",SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),"cCom",SUM('Informe Reservas Total'[room_commission_price])+SUM('Informe Reservas Total'[cf_commission_price])),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Status]="CANCELLED"&&YEAR('Informe Reservas Total'[Fecha Estancia])=${year}))`,


    salesCancLY: `EVALUATE CALCULATETABLE(SUMMARIZECOLUMNS('Fechas estancia'[Year],'Fechas estancia'[Month],Habitaciones[Property],Habitaciones[Tipo Habitación],Habitaciones[Location],'Informe Reservas Total'[Source Filtro],'Informe Reservas Total'[Rate plan],'Informe Reservas Total'[Country],"cRN",COUNTROWS('Informe Reservas Total'),"cBK",DISTINCTCOUNT('Informe Reservas Total'[Refer]),"cRev",SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),"cCom",SUM('Informe Reservas Total'[room_commission_price])+SUM('Informe Reservas Total'[cf_commission_price])),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Status]="CANCELLED"&&YEAR('Informe Reservas Total'[Fecha Estancia])=${prevYear}))`,
    ...
    paceLead: `EVALUATE ROW("n0",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Create time]<=${todayDAX}&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=1),FILTER('Fechas estancia','Fechas estancia'[Date]>=${todayDAX})),"r0",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Create time]<=${todayDAX}&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=1),FILTER('Fechas estancia','Fechas estancia'[Date]>=${todayDAX})),"n1",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Create time]<=${todayDAX}&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=2&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=7),FILTER('Fechas estancia','Fechas estancia'[Date]>=${todayDAX})),"r1",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Create time]<=${todayDAX}&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=2&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=7),FILTER('Fechas estancia','Fechas estancia'[Date]>=${todayDAX})),"n2",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Create time]<=${todayDAX}&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=8&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=14),FILTER('Fechas estancia','Fechas estancia'[Date]>=${todayDAX})),"r2",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Create time]<=${todayDAX}&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=8&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=14),FILTER('Fechas estancia','Fechas estancia'[Date]>=${todayDAX})),"n3",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Create time]<=${todayDAX}&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=15&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=30),FILTER('Fechas estancia','Fechas estancia'[Date]>=${todayDAX})),"r3",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Create time]<=${todayDAX}&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=15&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=30),FILTER('Fechas estancia','Fechas estancia'[Date]>=${todayDAX})),"n4",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Create time]<=${todayDAX}&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=31&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=60),FILTER('Fechas estancia','Fechas estancia'[Date]>=${todayDAX})),"r4",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Create time]<=${todayDAX}&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=31&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=60),FILTER('Fechas estancia','Fechas estancia'[Date]>=${todayDAX})),"n5",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Create time]<=${todayDAX}&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=61&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=90),FILTER('Fechas estancia','Fechas estancia'[Date]>=${todayDAX})),"r5",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Create time]<=${todayDAX}&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>=61&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)<=90),FILTER('Fechas estancia','Fechas estancia'[Date]>=${todayDAX})),"n6",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Create time]<=${todayDAX}&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>90),FILTER('Fechas estancia','Fechas estancia'[Date]>=${todayDAX})),"r6",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Create time]<=${todayDAX}&&DATEDIFF('Informe Reservas Total'[Create time],'Informe Reservas Total'[Fecha Estancia],DAY)>90),FILTER('Fechas estancia','Fechas estancia'[Date]>=${todayDAX})))`,
    ...
    cancCh: `EVALUATE SUMMARIZECOLUMNS(
      ...
      FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total',
        ...
        YEAR('Informe Reservas Total'[Fecha Estancia])=${year}&&
        'Informe Reservas Total'[Conexion]="OK"
      ),
