...
ytdToday: `EVALUATE ROW("Rev",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F26}&&'Informe Reservas Total'[Fecha Estancia]<=${todayDAX})),"RN",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F26}&&'Informe Reservas Total'[Fecha Estancia]<=${todayDAX})),"BK",CALCULATE(DISTINCTCOUNT('Informe Reservas Total'[Refer]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F26}&&'Informe Reservas Total'[Fecha Estancia]<=${todayDAX})),"Ni",CALCULATE(SUM('Informe Reservas Total'[Nights]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F26}&&'Informe Reservas Total'[Fecha Estancia]<=${todayDAX})),"Rev25",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F25}&&'Informe Reservas Total'[Fecha Estancia]<=${prevYearSameDay})),"RN25",CALCULATE(COUNTROWS('Informe Reservas Total'),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F25}&&'Informe Reservas Total'[Fecha Estancia]<=${prevYearSameDay})),"BK25",CALCULATE(DISTINCTCOUNT('Informe Reservas Total'[Refer]),FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER(ALL('Informe Reservas Total'),${F25}&&'Informe Reservas Total'[Fecha Estancia]<=${prevYearSameDay})))`,
    ...
    forecastPk: `EVALUATE SUMMARIZECOLUMNS('Fechas estancia'[Month],Habitaciones[Property],Habitaciones[Tipo Habitación],FILTER(Habitaciones,Habitaciones[Activo_Condicional]="Activo"),FILTER('Informe Reservas Total','Informe Reservas Total'[Alojamiento] IN ${alojIN}&&'Informe Reservas Total'[Conexion]="OK"&&'Informe Reservas Total'[Status]="CONFIRMED"&&'Informe Reservas Total'[Fecha Estancia]>=${prevYearSameDay}&&${_yEst(prevYear)}),"P7R",CALCULATE(COUNTROWS('Informe Reservas Total'),'Informe Reservas Total'[Create time]>=${prevYearSameDay}&&'Informe Reservas Total'[Create time]<=${prevYearSameDay}+7),"P15R",CALCULATE(COUNTROWS('Informe Reservas Total'),'Informe Reservas Total'[Create time]>=${prevYearSameDay}&&'Informe Reservas Total'[Create time]<=${prevYearSameDay}+15),"P30R",CALCULATE(COUNTROWS('Informe Reservas Total'),'Informe Reservas Total'[Create time]>=${prevYearSameDay}&&'Informe Reservas Total'[Create time]<=${prevYearSameDay}+30),"P45R",CALCULATE(COUNTROWS('Informe Reservas Total'),'Informe Reservas Total'[Create time]>=${prevYearSameDay}&&'Informe Reservas Total'[Create time]<=${prevYearSameDay}+45),"P7V",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),'Informe Reservas Total'[Create time]>=${prevYearSameDay}&&'Informe Reservas Total'[Create time]<=${prevYearSameDay}+7),"P15V",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),'Informe Reservas Total'[Create time]>=${prevYearSameDay}&&'Informe Reservas Total'[Create time]<=${prevYearSameDay}+15),"P30V",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),'Informe Reservas Total'[Create time]>=${prevYearSameDay}&&'Informe Reservas Total'[Create time]<=${prevYearSameDay}+30),"P45V",CALCULATE(SUM('Informe Reservas Total'[ADR ING])+SUM('Informe Reservas Total'[Cleaning Diario])+SUM('Informe Reservas Total'[Extras Diario]),'Informe Reservas Total'[Create time]>=${prevYearSameDay}&&'Informe Reservas Total'[Create time]<=${prevYearSameDay}+45))`,
...
function processData(raw, year) {
  ...
  return {
    ...
    dp26, dp25,
    fcPk: (function(){ var a=raw.forecastPk||[]; var k=a[0]?Object.keys(a[0]):[]; var km=k.find(function(x){return x.indexOf('Month')>=0;})||'', kp=k.find(function(x){return x.indexOf('Property')>=0;})||'', ku=k.find(function(x){return x.indexOf('Tipo Habit')>=0;})||''; return a.map(function(r){ return { mo:((km&&r[km])||1)-1, grp:(kp&&r[kp])?r[kp]:'?', unit:(ku&&r[ku])?String(r[ku]).replace(/[()]/g,''):'?', pk:{ '7':{rn:r['[P7R]']||0,rev:Math.round(r['[P7V]']||0)}, '15':{rn:r['[P15R]']||0,rev:Math.round(r['[P15V]']||0)}, '30':{rn:r['[P30R]']||0,rev:Math.round(r['[P30V]']||0)}, '45':{rn:r['[P45R]']||0,rev:Math.round(r['[P45V]']||0)} } }; }).filter(function(x){return x.unit!=='?';}); })(),
